...
&nbsp;&nbsp;
        ...
        &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="Ingrese solo letras" ValidationExpression="^[A-Za-zá-úÁ-ÚñÑ ]*$" ValidationGroup="obligatorio"></asp:RegularExpressionValidator>
        <br />
        <br />
...
&nbsp;
        ...
        &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBox2" ErrorMessage="Ingrese solo letras" ValidationExpression="^[A-Za-zá-úÁ-ÚñÑ ]*$" ValidationGroup="obligatorio"></asp:RegularExpressionValidator>
        <br />
        <br />
